...
| `../agreements/consultant-agreement.html` | **DRAFT** Non-Director Services Agreement — the Firm (Hesca, as sole director and shareholder) and Maryke. Clause 1 is the point of it: not a director, no shares, no partnership, no interest in the practice or goodwill, no management rights, no claim on termination or sale. Then supervision, what Maryke may not do or sign, no trust-account authority, firm ownership of work/systems/data, confidentiality and POPIA, restraint, indemnity. Six pages: agreement and signatures (1-3), Annexure A scope of services mapped to the nine transfer stages (4), Annexure B remuneration with four fee options to choose between (5), and a detachable internal note listing what Hesca must settle (6). **Not advice — Hesca settles it.** |
